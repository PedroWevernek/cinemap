...
begin
  MediaPlayer1.Filename:= 'H:/Filmes/3 COMÉDIA/Projeto X - Uma Festa fora de controle (www.ThePirateFilmes.com)/Projeto X - Uma Festa fora de controle (www.ThePirateFilmes.com).mp4';
  MediaPlayer1.Open;
  MediaPlayer1.Play;
end;
